...
class ApplicationTokenHelper {
    ...
    static createToken(name) {
        return this.isObject(name)
            ...
            : ApplicationToken_1.ApplicationToken.create(name, tsyringe_1.container.resolve(ApplicationToken_1.ApplicationToken).generateIdentifier(), this.generateIssuedTime());
    }
    static copyToken(t) {
