...
describe('Application Token Helper', function () {
    ...
    it('static method token is about to expire', function () {
        const id = ApplicationTokenHelper_1.ApplicationTokenHelper.createToken('test');
        expect(ApplicationTokenHelper_1.ApplicationTokenHelper.isAboutToExpire(id)).toBe(false);
        id.issued = new Date().getTime() - 1000;
        expect(ApplicationTokenHelper_1.ApplicationTokenHelper.isAboutToExpire(id)).toBe(true);
    });
});
